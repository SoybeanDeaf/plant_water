...
class SensorService:
    def __init__(self, mqtt_message_service: MQTTMessageService, db_connection: Connection):
    ...
    def save_reading_to_db(self, msg_payload) -> None:
        self.db_connection.cursor().execute(f"INSERT INTO moisture_reading VALUES ({msg_payload.get('moisture_level')}, '{msg_payload.get('measured_at')}')")
